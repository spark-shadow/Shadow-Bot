...
if (config.STANDPLK == 'off' || config.STANDPLK == 'OFF') {
    ...
    MyPnky.addCommand({pattern: 'autobio ?(.*)', fromMe: wk, desc: auto_dsc, usage: '.autobio on / off' }, (async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'detectlang$', fromMe: wk, desc: dlang_dsc}, (async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: wk}, (async (message, match) => {
    ...
    if (config.LANG == 'TR' || config.LANG == 'AZ') {
        ...
        MyPnky.addCommand({pattern: 'tts (.*)', fromMe: wk, desc: Lang.TTS_DESC}, (async (message, match) => {
...
await message.client.sendMessage(message.jid, {displayname: "Shadow⚡", vcard: p_lk}, MessageType.contact, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(message.jid ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": Config.BOTPLK, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./uploads/image/logo.jpg')}}}});
    ...
    MyPnky.addCommand({pattern: 'video ?(.*)', fromMe: wk, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'yt ?(.*)', fromMe: wk, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'wiki ?(.*)', fromMe: wk, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'img ?(.*)', fromMe: wk, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({ pattern: 'github ?(.*)', fromMe: wk, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'lyric ?(.*)', fromMe: wk, desc: Slang.LY_DESC }, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: "covid ?(.*)", fromMe: wk, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
