...
MyPnky.addCommand({pattern: 'qr ?(.*)', fromMe: wk, desc: 'Converts the given text into a qr code image.'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Coded by Shadow-Bot',quoted: message.data,thumbnail: "https://i.imgur.com/w9pe1Z1.jpeg"})
