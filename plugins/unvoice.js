...
MyPnky.addCommand({pattern: 'unvoice', fromMe: wk, desc: Lang.UV_DESC}, (async (message, match) => {    
...
MyPnky.addCommand({pattern: '2 ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
...
MyPnky.addCommand({pattern: '1', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
...
MyPnky.addCommand({pattern: 'unimage', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {    
